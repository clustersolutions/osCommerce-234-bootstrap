...
define('COUPON_STARTDATE', 'Start Date (default is today)');
define('COUPON_FINISHDATE', 'End Date (default is today + 1 Month)');
...
//BOE CCGV fnzb
define('ERROR_NO_COUPON_NAME', 'Error: No coupon name has been entered.');
define('ERROR_NO_COUPON_DATES', 'Error: Check that you have entered valid start and end dates for the coupon.');
//EOE CCGV fnzb
