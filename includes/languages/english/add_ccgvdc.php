...
define('VOUCHER_BALANCE', 'Let\'s apply my %s store credit.');
define('BOX_HEADING_GIFT_VOUCHER', 'Store Credit Account'); 
...
define('ERROR_NO_INVALID_REDEEM_GV', 'Prome Code Invalid'); 
