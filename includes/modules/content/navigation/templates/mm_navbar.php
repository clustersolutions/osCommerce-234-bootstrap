<nav class="navbar yamm navbar-inverse navbar-no-corners navbar-no-margin navbar-fixed-top" role="navigation">
    ...
    <div class="collapse navbar-collapse" id="bs-navbar-collapse-1">
      <div class="container-fluid">
        <ul class="nav navbar-nav">
          ...
          <?php echo '<li><a href="' . tep_href_link('wordpress/') . '">' . 'Blog' . '</a></li>'; ?>
        </ul>
