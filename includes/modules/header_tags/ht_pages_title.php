  ...
  class ht_pages_title {
    ...
    function execute() {
      ...
      if ( (defined('META_SEO_TITLE')) && (strlen(META_SEO_TITLE) > 0) ) {
        $oscTemplate->setTitle(tep_output_string(META_SEO_TITLE)  . MODULE_HEADER_TAGS_PAGES_TITLE_SEPARATOR . $oscTemplate->getTitle());
      }
    ...
    function install() {
      ...
      tep_db_query( "insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Separator', 'MODULE_HEADER_TAGS_PAGES_TITLE_SEPARATOR', '-', 'The separator to put between this element and the following element.', '6', '2', now())" );
    }
    ...
    function keys() {
      return array('MODULE_HEADER_TAGS_PAGES_TITLE_STATUS', 'MODULE_HEADER_TAGS_PAGES_TITLE_SORT_ORDER', 'MODULE_HEADER_TAGS_PAGES_TITLE_SEPARATOR');
    }
  }
?>
