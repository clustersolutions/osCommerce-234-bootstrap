...
<div class="contentContainer">
    ...
    <div class="col-sm-4">
      <div class="panel panel-primary">
        ...
        <div class="panel-body">
          <?php echo tep_address_phone_label($customer_id, $customer_default_address_id, true, ' ', '<br />'); ?>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="contentText row">
<?php
  $addresses_query = tep_db_query("select address_book_id, entry_firstname as firstname, entry_lastname as lastname, entry_company as company, entry_street_address as street_address, entry_suburb as suburb, entry_city as city, entry_postcode as postcode, entry_state as state, entry_zone_id as zone_id, entry_country_id as country_id, entry_telephone as telephone, entry_fax as fax from " . TABLE_ADDRESS_BOOK . " where customers_id = '" . (int)$customer_id . "' order by firstname, lastname");
